    ...
    return (
        <div className={clsx(className, 'ford-component-container')}>
            ...
            <div className={'ford-quote'}>
                <div>
                    Наша компания основана в 2007 году. За прошедшие годы было  реализовано много проектов. Услуги широкоформатная печати – основной  вид деятельности нашей компании. Мы «попадаем в цвет», даем реальные  сроки и соблюдаем их. Нам самим нравится качество нашей работы.
                </div>
