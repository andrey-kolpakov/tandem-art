            ...
            popupContent:
                <div className={'interior-print__popup-form'}>
                    ...
                    <div className={'interior-print__popup-form-text'} style={{fontSize: '14px'}}>
                        ...
                        <p>
                            Изготовление наклеек плоттером позволяет получить продукцию любой формы и сложности, что особенно ценно для дизайнеров и рекламных агентств.
                        </p>
            ...
            popupContent:
                <div className={'interior-print__popup-form'}>
                    ...
                    <div className={'interior-print__popup-form-text'} style={{fontSize: '14px'}}>
                        ...
                        <p>Roll Up (Ролл ап) и Х-конструкцию можно использовать внутри, снаружи помещений. Они мобильны, благодаря чему при решении о проведении кампании в ином месте или ухудшении погодных условий их можно быстро свернуть и переместить без каких-либо неудобств.
                        </p>
