...
const Component = () => {
    return(
        <div className={'interior-print__popup-form'}>
            <Image src={'/images/sticker-popup-background.jpg'} width={200} height={200} alt={"Печать на холсте"}/>

            <div className={'interior-print__popup-form-text'}>
                <h2>СОЗДАЁМ ТО, ЧТО ЗАПОМИНАЕТСЯ</h2>
                <section className="sticker-info">
                    <h1>Наклейки (стикеры)</h1>
                    <p>
